...
local function runOnce(cmdArr)
    for _, cmd in ipairs(cmdArr) do
        ...
        awful.spawn.with_shell(
            "xrandr --auto --output eDP1 --mode 1920x1080 --primary --output HDMI2 --mode 2560x1440 --right-of eDP1");
    end
end
...
--[[ dmenu
    ...
    -- ]]
-- Awesome menubar
    awful.key({ modkey, "Shift" }, "w", function() awful.util.rcMainMenu:show() end,
    ...
    awful.key({ modkey }, "d", function() awful.util.spawn("rofi -show drun") end,
        { description = "Show rofi applications.", group = "Hotkeys" }),
